...
export default function AttachmentQuiz() {
  ...
  const handleLoveReset = () => {
    // Trigger Payhip overlay checkout
    if (window.Payhip) {
      window.Payhip.Checkout.open({ product: 'uWMgQ' });
    } else {
      window.open(LOVE_RESET_URL, '_blank');
    }
  };
          ...
          {screen === 'result' && info && (
            <div>
              ...
              <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl p-6 mb-4 border border-rose-100">
                ...
                <button onClick={handleLoveReset}
